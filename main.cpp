...
Description: main.cpp dictates the flow of the game and compiles all the functions
		...
		*****************/
		...
		while (!quit)
		{
			...
			else
			{
				...
				else if (board.covered_board[row][col] == '*') // if tile is uncovered
				{
					board.covered_board[row][col] = board.raw_board[row][col];
					board.uncovered++;
				}
